...
impl Grid {
	...
	#[allow(unused)]
	fn unpair(id: GridPairId) -> GridVec { // elegant unpairing, modified to work with negative numbers. DO NOT LOOK INSIDE UNDER ANY CIRCUMSTANCES. This method is mostly for debugging anyways
